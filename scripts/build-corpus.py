...
LEGACY_ASSETS = {"assets/releases/v18.1-alignment.jpg", "assets/releases/v18.2-origin.jpg",
                 ...
                 "assets/origin-radial.png", "assets/origin-scene.json",
                 "assets/origin-v17.css", "assets/origin-v17.js"}
...
<header class="document-header"><a href="/">Governed Logic<br>Reasoning Systems</a><a href="/concepts/">Canonical definitions →</a></header>
...
def outputs(root):
    ...
    manifest["discovery"] = {"generator": GENERATOR, "contentVersion": manifest["version"],
                              "releaseChannel": manifest.get("releaseChannel", "production"),
